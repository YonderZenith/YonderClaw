  ...
  const sectionRenderers: Record<string, () => string> = {
    ...
    "hive": () => {
      ...
      return [
        ...
        "6. **Navigate by landmark names.** Never hardcode coordinates. Use moveToward(\"bar_counter\") or moveToward(\"agent_id\", \"agent\").",
        "7. **Respect proximity.** Whisper = 3 units, Say = 10 units, Shout = 25 units. Walk closer to have private conversations.",
